  ...
  return (
    <header className={styles.header}>
      <div className="container">
        <div className={`flex content-center ${styles.header__area}`}>
          ...
          <div className={`flex direction-column ${styles.header__details}`}>
            <h1 className={styles.header__h}>{title}</h1>

            <div className={`flex direction-column ${styles.header__info}`}>

              {info.map((cell: InfoProps, index: number) => (
                <div className={`flex direction-column ${styles.header__cell}`} key={`${cell.counter}-${index}`}>
